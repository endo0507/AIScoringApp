...
1. ~~「問題・採点条件」のところにある、「認識」を押す。~~
2. 問題用紙の中の、問題文と採点条件の全文を「問題・採点条件」のテキストボックスにコピペ  
   （教員が問題用紙のデータからコピペするのを想定）
3. 「ファイルを選択」(Choose File)を押し、解答サンプル画像を開く。
4. 「解答」のところにある、「認識」を押す。
5. 画像内から模範解答の方の１文だけを範囲選択する。
   (認識が始まり、30秒くらいかかります)
7. ~~「問題・採点条件」と~~「解答」の文字認識が正しく行えていることを確認する。
8. 「採点開始」を押して、AIによる採点を行う。
9. 「採点結果」欄の内容を確認する。
## 既知の不具合
